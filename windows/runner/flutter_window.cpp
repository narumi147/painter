                              ...
                              LPARAM const lparam) noexcept
{
  ...
  case WM_EXITSIZEMOVE:
    RECT rect;
    if (painter_channel && GetWindowRect(hwnd, &rect))
    {
      painter_channel->InvokeMethod(
          "onWindowPos",
...
{
  painter_channel = std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(engine->messenger(), "painter.narumi.cc/painter",
                                                                                      &flutter::StandardMethodCodec::GetInstance());
  painter_channel->SetMethodCallHandler([this](
